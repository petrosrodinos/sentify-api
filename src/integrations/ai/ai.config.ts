...
export class AiConfig {
    ...
    getSystemPrompt() {
        ...
        You are a social media sentiment and news analyst expert specialized in crypto and stock market. You are given a list of posts and you need to analyze the most important and relevant posts grouped by the users screen_name.do not create an item for each post and provide a json array with the following schema
        `;
