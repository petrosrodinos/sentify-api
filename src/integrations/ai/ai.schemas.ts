...
export const PostAnalysisSchema = z.object({
    ...
    tickers: z.array(z.object({
        ticker: z.string().describe('TSLA/BTC/ETH/key words/etc tickers of companies,crypto,commodities,key words that are relevant to the post,not empty,not with $'),
