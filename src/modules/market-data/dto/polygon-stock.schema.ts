...
export const GetStockAggregatesSchema = z.object({
    ticker: z.string(),
    ...
    type: z.enum(['CS', 'ADRC', 'ADRP', 'ADRS', 'ADRT', 'ADRU', 'ADRZ', 'BDR', 'ETF', 'FUT', 'FUT_C', 'FUT_P', 'FUT_U', 'FUT_X', 'FUT_Z', 'IND', 'MUT', 'MUT_C', 'MUT_P', 'MUT_U', 'MUT_X', 'MUT_Z', 'OPT', 'OPT_C', 'OPT_P', 'OPT_U', 'OPT_X', 'OPT_Z', 'STK', 'STK_C', 'STK_P', 'STK_U', 'STK_X', 'STK_Z', 'WAR', 'WAR_C', 'WAR_P', 'WAR_U', 'WAR_X', 'WAR_Z']).optional().default('CS'),
    adjusted: z.coerce.boolean().optional().default(true),
